...
var Dialog = function () {
    ...
    _createClass(Dialog, [{
        key: '_notify',
        value: function _notify(event_name) {
        ...
        value: function _initialize(open_event) {
            ...
            if (self.options.min_width) {
                content.css('min-width', self.options.min_width);
            }
            ...
            if (self.options.min_height) {
                body.css('min-height', self.options.min_height);
            }
        ...
        key: '_form_ajax_submit',
        value: function _form_ajax_submit() {
            var with_errors = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
...
window.FrontendForms = function () {
    ...
    function display_server_error(errorDetails) {
        ...
        try {
            ...
            swal.fire((_swal$fire = {
                ...
                type: 'error',
                icon: 'error'
            }, _defineProperty(_swal$fire, 'confirmButtonClass', 'btn btn-lg btn-danger'), _defineProperty(_swal$fire, 'confirmButtonText', gettext('Close')), _swal$fire));
        }
    ...
    function display_message(html_content) {
        ...
        var message_type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'success';
    ...
    function redirect(url) {
        var show_layer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    ...
    function reload_page() {
        var show_layer = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
    ...
    function confirmRemoteAction(url, options, afterDoneCallback) {
